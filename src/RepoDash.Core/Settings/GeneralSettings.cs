...
public sealed class GeneralSettings
{
    ...
    [Description("Provide path to TotalCommander to use it instead of default file explorer.")]
    ...
    [Description("Repositories which don't contain an SLN will be opened with this tool." +
        "Leave empty to open in file explorer")]
    public string? NonSlnRepoEditorPath { get; set; }

    [Category("5. Remote")]
    [DisplayName("Remote Pipelines Url Part")]
    [Description("Relative path appended to a repository page URL to open its pipelines/runs list" +
    ...
    [Browsable(false)]
    public ObservableCollection<string> CustomGroupOrder { get; init; } = new();
